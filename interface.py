...
def emoji_display(sentiment):
   ...
   if (sentiment == 'anger'):
      Label(root, text=emoji.emojize(":enraged_face:"), font =('Times New Roman', '30'), bg = bg_col, fg = 'white').place(x = 450, y = 600)
   if (sentiment == 'fear'):
      Label(root, text=emoji.emojize(":fearful_face:"), font =('Times New Roman', '30'), bg = bg_col, fg = 'white').place(x = 450, y = 600)
   if (sentiment == 'sadness'):
      Label(root, text=emoji.emojize(":sad_but_relieved_face:"), font =('Times New Roman', '30'), bg = bg_col, fg = 'white').place(x = 450, y = 600)
   if (sentiment == 'joy'):
      Label(root, text=emoji.emojize(":grinning_face_with_big_eyes:"), font =('Times New Roman', '30'), bg = bg_col, fg = 'white').place(x = 450, y = 600)
   if (sentiment == 'love'):
      Label(root, text=emoji.emojize(":smiling_face_with_hearts:"), font =('Times New Roman', '30'), bg = bg_col, fg = 'white').place(x = 450, y = 600)
   if (sentiment == 'surprise'):
      Label(root, text=emoji.emojize(":anguished_face:"), font =('Times New Roman', '30'), bg = bg_col, fg = 'white').place(x = 450, y = 600)
